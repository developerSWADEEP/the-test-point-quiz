...
class _WalletScreenState extends State<WalletScreen>
      ...
      child: Column(
        children: [
                  ...
                  builder: (context, state) {
                    if (state is UserDetailsFetchSuccess) {
                      return Row(
                        ...
                        children: [
                          SvgPicture.asset(Assets.coin, width: 20, height: 20),
          ...
          CustomRoundedButton(
            ...
            textSize: 18,
            onTap: () {
              final enteredRedeemAmount = redeemableAmountTextEditingController!
                  .text
                  .trim();
  ...
  Container redeemCoinOptions(String coins) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Theme.of(
              context,
            ).colorScheme.onTertiary.withValues(alpha: 0.06),
            spreadRadius: 1,
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          SvgPicture.asset(Assets.coin, width: 15, height: 15),
  ...
  Widget _buildTransactionContainer({
    ...
    final payoutIndex = kPayoutMethods.indexWhere(
      (e) => e.type.toLowerCase() == paymentRequest.paymentType.toLowerCase(),
    );

    if (payoutIndex != -1) {
      paymentLogo = kPayoutMethods[payoutIndex].image;
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        controller: tabController,
        children: [_buildRequestContainer(), _buildTransactionListContainer()],
      ),
    );
  }
}
