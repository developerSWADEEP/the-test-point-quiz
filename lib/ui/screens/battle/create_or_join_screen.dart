...
import 'package:flutterquiz/commons/widgets/not_enough_coins_dialog.dart';
...
class _CreateOrJoinRoomScreenState extends State<CreateOrJoinRoomScreen> {
  ...
  void showJoinRoomBottomSheet() {
    ...
    showModalBottomSheet<bool?>(
            ...
            children: [
              ...
              Align(
                child: Text(
                  ...
                  style: TextStyle(fontSize: 16, color: colorScheme.onTertiary),
                ),
              ),
              const SizedBox(height: 30),
              Padding(
      ...
      if (value != null) {
        return UiUtils.showSnackBar(context.tr(enterRoomCodeMsg)!, context);
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<QuizCategoryCubit, QuizCategoryState>(
      listener: (context, state) {
