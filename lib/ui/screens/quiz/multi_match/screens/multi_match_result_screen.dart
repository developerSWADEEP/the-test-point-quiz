...
class _MultiMatchResultScreenState extends State<MultiMatchResultScreen> {
    ...
    return Screenshot(
      ...
      child: BlocConsumer<SetCoinScoreCubit, SetCoinScoreState>(
        ...
        builder: (context, state) {
          ...
          if (state is SetCoinScoreSuccess) {
            final showCoinScore =
                _isWinner && (state.earnCoin > 0 || state.earnScore > 0);
  ...
  Widget _buildReviewAnswersButton() {
    ...
    return _buildButton(context.tr('reviewAnsBtn')!, () {
  ...
  Widget _buildShareYourScoreButton() {
    ...
    return Builder(
      builder: (context) {
        return _buildButton(context.tr('shareScoreBtn')!, onTap, context);
      },
    );
  }
  ...
  Widget _buildHomeButton() {
    ...
    return _buildButton(context.tr('homeBtn')!, onTapHomeButton, context);
  }
}
