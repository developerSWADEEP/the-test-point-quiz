...
class _QuizScreenState extends State<QuizScreen> with TickerProviderStateMixin {
  ...
  late AnimationController audioTimerController = AnimationController(
    ...
    duration: Duration(
      seconds: widget.quizType == QuizTypes.audioQuestions
          ? context.read<SystemConfigCubit>().quizTimer(
  ...
  void navigateToResultScreen() {
    ...
    final usedLifeLine = lifelines.values.any((e) => e == LifelineStatus.used);
    ...
    Navigator.of(context).pushReplacementNamed(
      ...
      arguments: {
        ...
        'hasUsedAnyLifeline': usedLifeLine,
  ...
  Future<void> submitAnswer(String submittedAnswer) async {
    ...
    if (!context
      ...
      context.read<QuestionsCubit>().updateQuestionWithAnswerAndLifeline(
        ...
        context.read<SystemConfigCubit>().quizCorrectAnswerCreditScore(
          widget.quizType,
        ),
        context.read<SystemConfigCubit>().quizWrongAnswerDeductScore(
          widget.quizType,
        ),
      );
      ...
      onTap:
          title == fiftyFifty &&
              context
                  ...
                  2
          ? () {
              UiUtils.showSnackBar(context.tr('notAvailable')!, context);
            }
          : onTap,
      child: Container(
