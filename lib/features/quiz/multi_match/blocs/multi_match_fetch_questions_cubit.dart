...
class MultiMatchFetchQuestionsCubit
  ...
  Future<void> fetchQuestions({
    ...
    try {
      ...
      emit(MultiMatchQuestionsSuccess(questions: questions, currentScore: 0));
  ...
  void submitAnswer(
    ...
    if (answerType == MultiMatchAnswerType.multiSelect) {
      isCorrectlyAnswered =
          correctAnswersIds.length == submittedAnswersIds.length &&
    ...
    emit(
      successState.copyWith(questions: questions, currentScore: updatedScore),
    );
  }
}
