...
class SystemConfigModel {
  SystemConfigModel({
    ...
    required this.multiMatchWrongAnswerDeductScore,
    required this.multiMatchCorrectAnswerCreditScore,
  ...
  SystemConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    guessTheWordMaxWinningCoins = int.parse(
      json['guess_the_word_max_winning_coin'] as String? ?? '0',
    );
    ...
    maxWinningCoins = int.parse(
      json['maximum_winning_coins'] as String? ?? '0',
    );
    ...
    multiMatchWrongAnswerDeductScore = int.parse(
      json['multi_match_wrong_answer_deduct_score'] as String,
    );
    multiMatchCorrectAnswerCreditScore = int.parse(
      json['multi_match_correct_answer_credit_score'] as String,
    );
  ...
  late final int guessTheWordHintDeductCoins;
  ...
  late final bool multiMatchMode;
  late final int multiMatchDuration;
  late final int multiMatchWrongAnswerDeductScore;
  late final int multiMatchCorrectAnswerCreditScore;
}
